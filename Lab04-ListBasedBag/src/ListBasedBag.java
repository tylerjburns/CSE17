    ...
    implements Bag<T>
{
    ...
    private ArrayList<T>     contents;              // the
                                                    // bag
                                                    // contents
     ...
     *
     * @param initialCapacity is the original size of the bag
     */
    ...
    public T removeRandom()
    {
        ...
        Random n = new Random();
        int position = n.nextInt(contents.size());
        T target = contents.get(position);
    ...
    public String toString()
    {
        ...
        for (int i = 0; i < contents.size(); i++)
        {
            ...
            {
                stringForm += contents.get(i).toString();
            }
            else
            {
                stringForm += contents.get(i).toString() + ", ";
